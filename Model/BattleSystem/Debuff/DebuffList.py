...
debuff2 = Debuff("Bleed", 2, 0, .1, "Receive 10% damage to hp per turn.",
                 image = pygame.image.load('../View/Graphics/debuff_bleed.png'))
debuff3 = Debuff("Poison", 10, 0, .01, "Receive 1% damage to hp per turn.",
...
debuff5 = Debuff("Bleed-Hemorrhage", 4, 0, .2, "Receive 20% damage to hp per turn.",
                 image = pygame.image.load('../View/Graphics/debuff_bleed.png'))
debuff_list = [debuff0,
               debuff1,
               debuff2,
