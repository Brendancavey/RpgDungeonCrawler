...
enemy0 = Enemy("Slime", 10, 3, attack_patterns[0], pygame.image.load('../View/Graphics/goblin.png'))
...
enemy3 = Enemy("Degenerate Slime", 100, 110, attack_patterns[3], pygame.image.load('../View/Graphics/goblin.png'))
