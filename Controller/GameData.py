...
enemy3 = enemy_list[3]
enemy4 = enemy_list[3]
armor = Armor("Strong Armor", 3, 10, 3)
scroll = Accessory("Scroll of Power", 4, 15, 2)
...
weapon2 = Weapon("Pointy Sword", 2, 9, 2)
